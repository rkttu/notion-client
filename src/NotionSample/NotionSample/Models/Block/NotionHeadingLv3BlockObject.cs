...
public sealed class NotionHeadingLv3BlockObject : INotionBlockObject
{
    public NotionHeadingLv3BlockObject(JsonElement elem)
    {
        JsonElement = elem;
    }
    ...
    public IEnumerable<INotionRichTextObject?> RichText =>
        JsonElement.TryGetProperty("heading_3", out JsonElement elem) ?
